...
//si es correcto creamos una variable de sesion llamada nombre y tenga el valor  "Ana Valle"
  ...
  if($entidadUsuario->verificarClave($clave,$entidadUsuario->clave)){
    ...
    //Si no correcto la clave o el usuario mostrar en pantalla "Usuario o contrañesa incorrecto" 
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="txtUsuario"
                                                name="txtUsuario" aria-describedby="emailHelp" value="admin"
                                                placeholder="Usuario">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="txtClave"
                                                name="txtClave" value="admin123" placeholder="contraseña">
                                        </div>
